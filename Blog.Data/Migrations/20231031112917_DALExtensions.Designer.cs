...
namespace Blog.Data.Migrations
{
    ...
    [Migration("20231031112917_DALExtensions")]
            ...
            modelBuilder.Entity("Blog.Entity.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f5e0357a-5910-4a4b-a8bb-0ac0e88bdd0c"),
                            ...
                            CreatedBy = "Onur",
                            CreatedDate = new DateTime(2023, 10, 31, 14, 29, 16, 224, DateTimeKind.Local).AddTicks(3663),
                        ...
                        new
                        {
                            Id = new Guid("1c8e6cf0-26ba-4982-8474-0112bf957194"),
                            CategoryId = new Guid("0ca6f76f-fc1c-4c77-b688-bd76efad6082"),
                            Content = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla nec odio ac justo suscipit suscipit in id tortor. Sed euismod ultrices purus, id commodo nisi. Maecenas sed luctus mi. Phasellus auctor vestibulum ante, nec consectetur justo. Sed fermentum vehicula tortor, et egestas velit auctor eu. Donec nec efficitur turpis. Sed sollicitudin est at eros viverra, non tristique elit dictum. Aliquam convallis, lectus a condimentum dapibus, metus neque sagittis purus, eget gravida libero mauris et purus. Vivamus cursus, lectus vel malesuada feugiat, metus orci pharetra velit, vel hendrerit turpis tortor non mi. Nullam sem dolor, viverra ut tincidunt id, dignissim ac justo. Etiam non felis a tellus varius pulvinar.",
                            CreatedBy = "Onur",
                            CreatedDate = new DateTime(2023, 10, 31, 14, 29, 16, 224, DateTimeKind.Local).AddTicks(3671),
            ...
            modelBuilder.Entity("Blog.Entity.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Onur",
                            CreatedDate = new DateTime(2023, 10, 31, 14, 29, 16, 224, DateTimeKind.Local).AddTicks(4101),
                            IsDeleted = false,
                            Name = "Test"
                        },
                        new
                        {
                            ...
                            CreatedBy = "Onur",
                            CreatedDate = new DateTime(2023, 10, 31, 14, 29, 16, 224, DateTimeKind.Local).AddTicks(4106),
                            IsDeleted = false,
                            Name = "Test2"
                        });
                });
            ...
            modelBuilder.Entity("Blog.Entity.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Onur",
                            CreatedDate = new DateTime(2023, 10, 31, 14, 29, 16, 224, DateTimeKind.Local).AddTicks(4318),
                            FileName = "Test",
                            FileType = "jpg",
                            IsDeleted = false
                        },
                        new
                        {
                            ...
                            CreatedBy = "Onur",
                            CreatedDate = new DateTime(2023, 10, 31, 14, 29, 16, 224, DateTimeKind.Local).AddTicks(4323),
                            FileName = "Test2",
                            FileType = "jpg",
                            IsDeleted = false
                        });
